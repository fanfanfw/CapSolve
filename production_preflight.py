...
def _validate_component_environments(directory: Path, *, expected_uid: int = 0) -> dict[str, dict[str, str]]:
    ...
    api_queue = {"JOB_QUEUE_CAPACITY", "JOB_QUEUE_RETRY_AFTER_SECONDS", "JOB_MAX_ATTEMPTS", "JOB_RETENTION_HOURS", "SYNC_QUEUE_MAX_WAITING", "MAX_WORKERS", "GLOBAL_CHROME_SLOTS"}
